...
import net.freecraft.client.gui.container.UIInventoryContainer;
import net.freecraft.client.world.ClientWorld;

public class InventoryState extends InGameState {
	private UIInventoryContainer container;
	@Override
	public void start() {
		container = new UIInventoryContainer();
	}
	@Override
	public void update() {
		super.update();
